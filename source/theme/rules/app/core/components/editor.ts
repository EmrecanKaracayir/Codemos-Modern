...
export const getRules = (themeContext: ThemeContext): object => {
  ...
  const rules = {
    ...
    "editorGutter.deletedBackground": styles.basic.alt.red.pri,
    "editorGutter.deletedSecondaryBackground": styles.basic.def.red.pri,
    ...
    "editorGutter.modifiedBackground": styles.basic.alt.blue.pri,
    "editorGutter.modifiedSecondaryBackground": styles.basic.def.blue.pri,
