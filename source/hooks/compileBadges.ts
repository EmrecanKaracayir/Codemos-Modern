...
async function compileBadges(): Promise<void> {
  // Dynamics
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-release.svg"),
    true,
    false,
    false,
  );
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-vscode.svg"),
    true,
    false,
    false,
  );
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-downloads.svg"),
    true,
    true,
    false,
  );
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-sponsors.svg"),
    true,
    false,
    false,
  );
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-rating.svg"),
    true,
    false,
    true,
  );
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-en.svg"),
    false,
    false,
    false,
    "#FFFFFF",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-zh-cn.svg"),
    false,
    false,
    false,
    "#FFFF00",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-es.svg"),
    true,
    false,
    false,
    "#AD1519",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-ja.svg"),
    true,
    false,
    false,
    "#BC002D",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-ru.svg"),
    true,
    false,
    false,
    "#0036A7",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-pt-br.svg"),
    false,
    false,
    false,
    "#FFFF00",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-fr.svg"),
    false,
    false,
    false,
    "#FFFFFF",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-ko.svg"),
    false,
    false,
    false,
    "#FFFFFF",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-de.svg"),
    true,
    false,
    false,
    "#000000",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-zh-tw.svg"),
    false,
    false,
    false,
    "#FFFF00",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-it.svg"),
    false,
    false,
    false,
    "#FFFFFF",
  ...
  await fetchModifySvg(
    ...
    join(IMAGES_DIR, "badge-loc-tr.svg"),
    false,
    false,
    false,
    "#FFFFFF",
...
async function fetchModifySvg(
  ...
  // Wait for 1 second before each request to avoid hitting the rate limit of shields.io
  ...
  axios
    ...
    .then(async function (response) {
      if (response.status === 200) {
        ...
        // If the badge is the downloads badge...
        if (isDownloadsBadge) {
          const textElement = doc.querySelector("text");
          const text = textElement!.textContent;

          // Control rate limit text
        ...
        // If the badge is the rating badge...
        if (isRatingBadge) {
          const textElement = doc.querySelector("text");
          const text = textElement!.textContent;
        ...
        writeFile(path, modifiedSvg, "utf8", async function (error) {
          if (error) {
            console.log(error);
            process.exit(1);
          } else {
            ...
            renderAsync(modifiedSvgCompat, {
              ...
              writeFileSync(path.replace(".svg", ".png"), r.asPng());
              console.log(
