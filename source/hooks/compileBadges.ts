...
fetchModifySvg(
  "https://img.shields.io/github/sponsors/EmrecanKaracayir?labelColor=373737&color=ef6363&label=&logo=data:image/svg+xml;base64,&logoColor=%23FFFFFFC7&style=for-the-badge",
  join(IMAGES_PATH, "badge-sponsors.svg"),
  true,
  false,
  false,
);
fetchModifySvg(
  ...
  join(IMAGES_PATH, "badge-rating.svg"),
  true,
  false,
  true,
);
...
fetchModifySvg(
  ...
  join(IMAGES_PATH, "badge-loc-en.svg"),
  false,
  false,
  false,
  "#FFFFFF",
...
fetchModifySvg(
  ...
  join(IMAGES_PATH, "badge-loc-es.svg"),
  true,
  false,
  false,
  "#AD1519",
...
fetchModifySvg(
  ...
  join(IMAGES_PATH, "badge-loc-ja.svg"),
  true,
  false,
  false,
  "#BC002D",
...
fetchModifySvg(
  ...
  join(IMAGES_PATH, "badge-loc-ru.svg"),
  true,
  false,
  false,
  "#0036A7",
...
fetchModifySvg(
  ...
  join(IMAGES_PATH, "badge-loc-pt-br.svg"),
  false,
  false,
  false,
  "#FFFF00",
    ...
    .then(async function (response) {
      if (response.status === 200) {
        ...
        if (isDownloadsBadge) {
          ...
          if (text!.toLowerCase().startsWith("rate limit")) {
